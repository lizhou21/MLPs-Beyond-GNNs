...
def evaluate(args, model, features, tag='dev'):
    ...
    if tag == 'dev':
        ...
        with open(args.log_file['test_file_3'], 'a') as file:
            json.dump(report, file)
            file.write('\n')
            
    elif tag == 'test_6':
        with open(args.log_file['test_file_6'], 'a') as file:
            json.dump(report, file)
            file.write('\n')
            
    elif tag == 'test_9':
        with open(args.log_file['test_file_9'], 'a') as file:
            json.dump(report, file)
            file.write('\n')
            
    elif tag == 'test_12':
        with open(args.log_file['test_file_12'], 'a') as file:
            json.dump(report, file)
            file.write('\n')
            
    elif tag == 'test_15':
        with open(args.log_file['test_file_15'], 'a') as file:
            json.dump(report, file)
            file.write('\n')

    elif tag == 'test_20':
        with open(args.log_file['test_file_20'], 'a') as file:
            json.dump(report, file)
            file.write('\n')
...
def main():
    ...
    args.log_file = {
        ...
        'test_file_3': os.path.join(log_dir, 'test_log_3.txt'),
        'test_file_6': os.path.join(log_dir, 'test_log_6.txt'),
        'test_file_9': os.path.join(log_dir, 'test_log_9.txt'),
        'test_file_12': os.path.join(log_dir, 'test_log_12.txt'),
        'test_file_15': os.path.join(log_dir, 'test_log_15.txt'),
        'test_file_20': os.path.join(log_dir, 'test_log_20.txt'),
    ...
    test_file_3 = os.path.join(Data_dir, "test_3.json")
    test_file_6 = os.path.join(Data_dir, "test_6.json")
    test_file_9 = os.path.join(Data_dir, "test_9.json")
    test_file_12 = os.path.join(Data_dir, "test_12.json")
    test_file_15 = os.path.join(Data_dir, "test_15.json")
    test_file_20 = os.path.join(Data_dir, "test_20.json")
    ...
    test_features_3 = processor.read(test_file_3, 'test_3')
    test_features_6 = processor.read(test_file_6, 'test_6')
    test_features_9 = processor.read(test_file_9, 'test_9')
    test_features_12 = processor.read(test_file_12, 'test_12')
    test_features_15 = processor.read(test_file_15, 'test_15')
    test_features_20 = processor.read(test_file_20, 'test_20')
    ...
    benchmarks = [
            ("dev", dev_features),
            ("test_3", test_features_3),
            ("test_6", test_features_6),
            ("test_9", test_features_9),
            ("test_12", test_features_12),
            ("test_15", test_features_15),
            ("test_20", test_features_20),
